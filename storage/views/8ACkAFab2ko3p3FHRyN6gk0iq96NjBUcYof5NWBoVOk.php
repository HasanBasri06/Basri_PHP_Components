...
// PUG_DEBUG:1
 ?>  <meta<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['http-equiv' => 'Content-Type'], ['content' => 'text/html;charset=UTF-8'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?> />
<?php 
\Phug\Renderer\Profiler\ProfilerModule::recordProfilerDisplayEvent(2);
// PUG_DEBUG:2
 ?>  <meta<?= (is_bool($_pug_temp = $pugModule['Phug\\Formatter\\Format\\BasicFormat::attributes_assignment'](['name' => 'viewport'], ['content' => 'width=device-width, initial-scale=1.0'], array(  ))) ? var_export($_pug_temp, true) : $_pug_temp) ?> />
<?php 
...
// PUG_DEBUG:5
 ?>Basri freamwork'üne hoşgeldiniz</h1>
<?php 
