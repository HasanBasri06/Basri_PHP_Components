...
// PUG_DEBUG:7
 ?><?php $__eachScopeVariables = ['user' => isset($user) ? $user : null];foreach ($users as $user) { ?><?php 
...
// PUG_DEBUG:5
 ?><?= htmlspecialchars((string) ((is_bool($_pug_temp = $GLOBALS['__jpv_dotWithArrayPrototype_with_ref']($user, 'name')) ? var_export($_pug_temp, true) : $_pug_temp))) ?></li>
